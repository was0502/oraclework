...
SELECT EMP_NAME, DEPT_CODE, DEPT_TITLE, SALARY, SALARY*12 연봉
 ...
 --> 오라클 전용 구문
 SELECT EMP_NAME, DEPT_TITLE,DEPT_TITLE,SALARY,SALARY*12 연봉
  FROM EMPLOYEE, DEPARTMENT
 WHERE DEPT_CODE=DEPT_ID(+);
    -- 기준으로 삼고자하는 테이블의 반대편 테이브르이 컬럼 뒤에(+) 붙이기
...
/*
    3)비둥가 조인
    : 매칭시킬 컬럼에 대한 조건식 작성시'=(동호)를 사용하지 않는 JOIN문
*/
