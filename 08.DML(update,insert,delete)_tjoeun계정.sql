/*
    *EML(DATA MENIPULATION LANGUAGE):데이터 조작 언너
    :테이블에 값은 삽입(INSERT)하거나, 수정(UPDATE),삭제(DELETE)하는 구문
*/
--=============================================================
/*
    *INSERT
    ...
    1) INSERT INTO 테이블명 VALUES(값1, 값2, 값3...);
        ...
        값의 갯수 부족하면 => NOT EMOUGH VALUE 오류
        값의 갯수 많으면 => TO MANY VALUES 오류
*/
...
/*
    * 조건을 사용하는 INSERT ALL
    ...
    서브쿼리;
*/
--2000년 이전에 입사한 사원들을 저장할 테이블 생성
CREATE TABLE EMP_OLD
AS SELECT EMP_ID, EMP_NAME, HIRE_DATE, SALARY
    FROM EMPLOYEE
    WHERE 1=0;
    
--2000년 이후에 입사한 사원들을 저장할 테이블 생성
...
--EMPLOYEE_COLY테이블에서 전체 사원의 급여를 기존의 급여에 10% 인상한 금액으로 변경
UPDATE EMPLOYEE_COPY
...
--다중열 서브쿼리 가능
UPDATE EMPLOYEE_COPY
SET(SALARY,BONUS)=  (SELECT BONUS, BONUS
                        FROM EMPLOYEE_COPY
                        WHERE EMP_NAME = '전정보')
WHERE EMP_NAME = '이고잉';
...
--ASIA지역에서 근무하는 사원들의 보너스 값을 0.3으로 변경(EMPLOYEE_COPY,DEPARTMENT)
UPDATE EMPLOYEE_COPY
SET BONUS = 0.3
