...
-- 숫자로 변결할 수 없는 값이 들어있어서 오류
ALTER TABLE DEPT_COPY MODIFY DEPT_ID NUMBER;

--DEPT_COPY테이블의 DEPT_TITLE의 자료형 CARCHAR(10)변경
...
--DEPT_COPY테이블의 LOCATION_ID 자료형 VARCHAR(2) 변경
--DEPT_COPY테이블의 LNAME컬럼의 기본값을 '미국'으로 변경

--다중변경 가능
ALTER TABLE DEPT_COPY
        MODIFY DEPT_TITLE VARCHAR2(40)
        MODIFY DEPT_TITLE VARCHAR2(2)
...
/*
    ...
    [표현법]
    RENAME CONSTRAINT 기존제약조건명 TO바꿀제약조건명
*/
--제약조건 넣기
ALTER TABLE DEPT_COPY
    ADD CONSTRAINT DCOPY_PK PRIMARY KEY(DEPT_ID)
