/*
    *DCL(DATA CONTROL LANGUAGE):데이터 제어 언어
    계정(사용자)에게 시스템 권한 또는 객체 접근권한을 부여(GRANT)하거나 회수(REVOKE)하는 구문
    ...
    >> 시스템 권한 : DB에 접근하는 권한, 객체를 생성할 수 있는 권한
        ...
        - CREATE SEQUENCE : 시원스쿨 생성할 수 있는 권한
        ...
...
/*
    *ROLE
    ...
    RESOURCR : CREATE TABLE + CREATE SEQUENCE + ...
    DBA : 시스템 및 객체관리에 대한 모든 권한을 갖고 있는 룰
    
    GRANT CONNET, RESOURCE TO 계정명; 
*/