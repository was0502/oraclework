/*
    *GROUP BY절
    그룹기준을 제시할 수 있는 구문(해당 그룹별로 여러 그룹으로 묶을 수 있음0
    여러개의 값들을 하나의 그룹으로 묶에서 처리할 목적으로 사용
*/
...
/*
    ...
    - CUBE(컬럼1, 컬럼2):컬러1을 가지고 중계집계를 내고, 컬럼2를 가지고도 중간집계를 냄
*/
-- 각 직급별 급여함
...
/*
    *집합 연산자 + SET OPERATION
    여러게의 쿼리문을 갖;고 하나의 쿼리문으로 만드는 연산자
    
    - UNION:OR|합집합(두 쿼리문을 수행항 결과값을 더한 후 중복되는 값은 한번만 조회)
    - INTERECT:AND|교집합(두 쿼리문을 수행한 결과값중 중복된 결과값 조회)
